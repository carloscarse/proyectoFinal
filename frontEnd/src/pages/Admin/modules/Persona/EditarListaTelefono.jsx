// proyecto/frontEnd/src/pages/Admin/modules/Persona/EditarListaTelefono.jsx
import React from "react";
import "./ListaTelefono.css";
import { getTelefonoLabel } from "../../../../utils/labels/telefono";

function EditarListaTelefono({ telefonos = [], onVer, onEditar, onEliminar }) {
  return (
...
export default EditarListaTelefono;