// proyecto/frontEnd/src/pages/Admin/modules/Persona/AgregarListaDireccion.jsx
import React from "react";
import "./ListaDireccion.css";

function AgregarListaDireccion({ direcciones = [], onVer, onEditar, onEliminar }) {
  return (
...
export default AgregarListaDireccion;